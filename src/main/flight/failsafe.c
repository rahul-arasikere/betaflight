...
void failsafeReset(void)
{
    ...
    failsafeState.rxDataRecoveryPeriod = PERIOD_RXDATA_RECOVERY + failsafeConfig()->failsafe_recovery_delay *
...
void failsafeUpdateState(void)
{
    ...
    do {
        ...
        case FAILSAFE_LANDED:
            ...
            failsafeState.receivingRxDataPeriod = millis() +
                                                  failsafeState.receivingRxDataPeriodPreset; // set required period of valid rxData
